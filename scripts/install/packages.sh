...
FD="${FD},alpine:fd-find,netbsd:fd,nixos:fd"
...
RIPGREP="${RIPGREP},freebsd:ripgrep,openbsd:ripgrep,alpine:ripgrep,nixos,netbsd:ripgrep,nixos:ripgrep"
...
FZF="${FZF},freebsd:fzf,openbsd:fzf,alpine:fzf,nixos,netbsd:fzf,nixos:fzf"
...
YAZI="${YAZI},alpine:yazi,nixos:yazi"
...
NEOVIM="${NEOVIM},freebsd:neovim,openbsd:neovim,alpine:neovim,nixos,netbsd:neovim,nixos:neovim"
...
HELiX="${HELiX},solus:helix,freebsd:helix,openbsd:helix,alpine:helix,nixos,netbsd:helix,nixos:helix"
...
EMACS="${EMACS},solus:emacs,freebsd:emacs,openbsd:emacs,alpine:emacs,nixos,netbsd:emacs,nixos:emacs"
...
ZSH="${ZSH},freebsd:zsh,openbsd:zsh,alpine:zsh,nixos,netbsd:zsh,nixos:zsh"
...
FISH="${FISH},solus:fish,freebsd:fish,openbsd:fish,alpine:fish,nixos,netbsd:fish,nixos:fish"
...
NUSHELL="${NUSHELL},alpine:nushell,nixos:nushell"
...
ZELLIJ="${ZELLIJ},freebsd:zellij,openbsd:zellij,alpine:zellij,nixos,netbsd:zellij,nixos:zellij"
...
TMUX="${TMUX},solus:tmux,freebsd:tmux,openbsd:tmux,alpine:tmux,nixos,netbsd:tmux,nixos:tmux"
...
SCREEN="${SCREEN},freebsd:screen,openbsd:screen,alpine:screen,nixos,netbsd:screen,nixos:screen"
...
GIT="${GIT},freebsd:git,openbsd:git,alpine:git,nixos,netbsd:git,nixos:git"
...
GH="${GH},freebsd:gh,openbsd:gh,alpine:gh,nixos,netbsd:gh,nixos:gh"
...
BTOP="${BTOP},freebsd:btop,openbsd:btop,alpine:btop,nixos,netbsd:btop,nixos:btop"
...
GLANCES="${GLANCES},freebsd:glances,openbsd:glances,alpine:glances,nixos,netbsd:glances,nixos:glances"
...
GPING="${GPING},solus:gping,freebsd:gping,openbsd:gping,alpine:gping,nixos,netbsd:gping,nixos:gping"
...
SPEEDTEST="${SPEEDTEST},openbsd:speedtest-cli,alpine:speedtest-cli,nixos,netbsd:speedtest-cli,nixos:speedtest-cli"
...
PRESENTERM="${PRESENTERM},alpine:presenterm,nixos:presenterm"
...
WGET2="${WGET2},freebsd:wget2,openbsd:wget2,alpine:wget2,nixos,netbsd:wget2,nixos:wget2"
...
RUST="${RUST},solus:rust,freebsd:rust,openbsd:rust,alpine:rust,nixos,netbsd:rust,nixos:rust"
...
TLDR="${TLDR},freebsd:tldr,openbsd:tldr,alpine:tldr,nixos,netbsd:tldr,nixos:tldr"
...
TEALDEER="${TEALDEER},alpine:tealdeer,nixos,netbsd:tealdeer,nixos:tealdeer"
...
CHEAT="${CHEAT},alpine:cheat,nixos:cheat"

# Security
AGE="fedora:age,ubuntu:age,debian:age,mint:age,arch:age,macos:age,windows:age"
AGE="${AGE},opensuse:age,amazon:age,almalinux:age,solus:age,alpine:age"
AGE="${AGE},freebsd:age,openbsd:age,alpine:age,nixos,netbsd:age,nixos:age"

ONEPASSWORD="fedora:1password-cli,ubuntu:1password-cli,debian:1password-cli"
ONEPASSWORD="${ONEPASSWORD},mint:1password-cli,arch:1password-cli,macos:1password-cli"
ONEPASSWORD="${ONEPASSWORD},windows:1password-cli,opensuse:1password-cli,amazon:1password-cli"
ONEPASSWORD="${ONEPASSWORD},almalinux:1password-cli,solus:1password-cli,alpine:1password-cli"
ONEPASSWORD="${ONEPASSWORD},freebsd:1password-cli,openbsd:1password-cli,netbsd:1password-cli"
ONEPASSWORD="${ONEPASSWORD},nixos:onepassword-cli"
...
UNAR="${UNAR},freebsd:unar,openbsd:unar,alpine:unar,nixos,netbsd:unar,nixos:unar"
...
PIGZ="${PIGZ},freebsd:pigz,openbsd:pigz,alpine:pigz,nixos,netbsd:pigz,nixos:pigz"

PXZ="fedora:pxz,ubuntu:pxz,debian:pxz,mint:pxz,arch:pxz,opensuse:pxz"
PXZ="${PXZ},amazon:pxz,almalinux:pxz,freebsd:pxz,alpine:pxz,nixos,netbsd:pxz,nixos:pxz"
...
FASTFETCH="${FASTFETCH},alpine:fastfetch,netbsd:fastfetch,nixos:fastfetch"
...
QALC="${QALC},alpine:qalculate,netbsd:qalculate,nixos:qalculate"
...
get_package_name() {
	...
	case "$tool" in
		1PASSWORD) tool="ONEPASSWORD" ;;
		1PASSWORD*) tool="ONEPASSWORD${tool#1PASSWORD}" ;;
	esac
